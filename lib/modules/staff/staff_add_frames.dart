...
class StaffAddFrameScreen extends StatefulWidget {
  const StaffAddFrameScreen({super.key});

  @override
  State<StaffAddFrameScreen> createState() => _StaffAddFrameScreenState();
}

class _StaffAddFrameScreenState extends State<StaffAddFrameScreen> {
